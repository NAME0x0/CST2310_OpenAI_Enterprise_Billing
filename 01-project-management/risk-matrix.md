...
| R4 | UML tool or PlantUML rendering issues prevent diagram completion | Low | Medium | **Low** | Use PlantUML in Markdown for version control; test rendering early in Week 9; maintain fallback diagrams.net files | Switch to diagrams.net or Lucidchart for affected diagrams; export as PNG for report | [Member 3] |
